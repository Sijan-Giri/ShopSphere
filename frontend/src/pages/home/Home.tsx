...
<div>
    ...
    >
        ...
        <section className="container mx-auto my-20 py-24 bg-gray-200 rounded-lg text-center">
            ...
            <p className="mt-8 text-xl font-light">Quis lectus nulla at volutpat diam ut. Enim lobortis scelerisque
                fermentum dui faucibus in.
            </p>
            <p className="mt-8">
                <button type="button"
                    className=" py-5 px-16 text-lg bg-teal-500 hover:bg-teal-600 rounded text-white ">Get Started
                    Now
                </button>
            </p>
        </section>
